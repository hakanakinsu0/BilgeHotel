...
namespace Project.Entities.Models
{
    ...
    /// Müşteri, oda, paket, ödeme, çalışan ve ekstra servis bilgileri ile ilişkilidir.
    /// </summary>
    public class Reservation : BaseEntity
    {
        ...
        public ReservationStatus ReservationStatus { get; set; } // Rezervasyonun mevcut durumu.
